...
class RLRunnerSUMO:
    def __init__(self, epsilon_point, RL_Agent, algo_name, junction_id, episodes=1000):
        ...
        self.episodes = episodes  # Number of episodes passed during init

        # Init RL agent
        self.rl_agent = RL_Agent(self.epsilon, self.learning_rate, self.epsilon_decay_rate, self.min_epsilon, self.epsilon_point)
        self.env = Env()  # Initialize SUMO environment

        # Metrics for tracking performance later for plot
        self.total_rewards = []
        ...
        for episode in range(self.episodes):
            ...
            for iteration in range(num_iterations):
                ...
                while not done:
                    ...
                    steps_in_episode += 1  # Increment the step count in this episode
    ...
    def display_results(self):
        """
        Display the results of the Q-learning after training is completed.
        """
